...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Site institucional real para pizzaria em Jarinu-SP: cardápio completo, pedidos via WhatsApp e SEO local.",
    tags: ["HTML", "CSS", "JavaScript", "SEO Local", "Cliente Real"],
    image: "/projects/capannone-pizzaria.png",
    problem: "Negócio local sem presença digital perde vendas: o cliente não encontra cardápio, endereço ou forma de pedir sem precisar telefonar.",
    architecture: "Site estático (sem build, sem dependências) com dados estruturados Schema.org (Restaurant) para SEO local, e um cardápio real com mais de 60 sabores extraídos do cardápio oficial do estabelecimento.",
    challenges: "Organizar um cardápio real e extenso (pizzas salgadas, doces, bordas, bebidas) de forma navegável, com todos os botões de pedido apontando direto para o WhatsApp real da pizzaria.",
    impact: "Projeto de cliente real (freelance): endereço, telefone e cardápio são verdadeiros, pronto para publicação após os ajustes finais do cliente.",
  ...
  },
  {
    ...
    featured: true,
    title: "Hazuki Sushi",
    description: "Site real para restaurante japonês em Jundiaí, com narrativa visual guiada por scroll no lugar do menu tradicional.",
    tags: ["HTML", "CSS", "JavaScript", "UI/UX", "Cliente Real"],
    image: "/projects/hazuki-sushi.png",
    problem: "O cliente precisava de uma identidade visual diferenciada, mas com todos os dados de contato reais e verificados — sem inventar nada que pudesse gerar prejuízo para o negócio.",
    architecture: "Página única com narrativa linear guiada por um trilho de progresso lateral (em vez de menu tradicional), tema escuro e tipografia serifada. Dados reais conferidos em fontes públicas e carregados via Schema.org.",
    challenges: "Separar o que era real do que era placeholder de forma honesta: horários sem fonte confirmada aparecem como 'a confirmar' na própria tela, e o cardápio de exemplo tem aviso visível — em vez de inventar informação que o cliente teria que corrigir depois.",
    impact: "Projeto de cliente real (freelance) em construção, com cuidado explícito de integridade de informação num contexto onde erro tem custo real para o dono do negócio.",
  ...
  },
  {
    ...
    description: "Dashboard denso em dados para monitorar uma plataforma fictícia de inferência de IA, com gráficos SVG feitos à mão.",
    tags: ["HTML", "CSS", "JavaScript", "SVG", "Design System"],
    image: "/projects/dashboard-kiln.png",
    problem: "Interfaces de operação (o painel que alguém abre de madrugada para decidir se precisa agir) costumam poluir o canal de cor com marca e decoração, fazendo o alerta real se perder no ruído visual.",
    architecture: "Site estático sem dependências nem build: os gráficos e sparklines são desenhados à mão em SVG pelo próprio script, sem nenhuma biblioteca de charts.",
    challenges: "Definir uma paleta onde a cor só é usada para codificar dado ou estado, nunca decoração — validada nos dois temas com checagem de contraste e de separação para daltonismo.",
    impact: "Demonstra raciocínio de design system aplicado (paleta com propósito, acessibilidade de cor, hierarquia de leitura) além da implementação, útil para qualquer dashboard denso em dados.",
  ...
  },
  {
    ...
    description: "Recriação funcional da interface de um chat em comunidade — servidores, canais e mensagens com estado real — com marca e ícones originais.",
    tags: ["HTML", "CSS", "JavaScript", "Acessibilidade", "UI/UX"],
    image: "/projects/orbit-chat-ui.png",
    problem: "Entender o que faz uma interface de chat complexa funcionar de verdade não é só copiar cores — é reproduzir agrupamento de mensagens, presença e microinterações que a maioria das recriações ignora.",
    architecture: "Site estático (HTML/CSS/JS puro, sem build). O estado da conversa é real: enviar, editar, reagir e responder mensagens altera os mesmos dados que a tela lê de volta.",
    challenges: "Replicar comportamentos finos como agrupamento de mensagens por tempo, respostas encenadas com indicador de digitação e navegação 100% por teclado com foco visível e leitura de tela corretos.",
    impact: "Mostra capacidade de dissecar e reconstruir uma interface complexa do zero, com atenção a detalhes de estado e acessibilidade que só aparecem em uso real, não em captura de tela.",
